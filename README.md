...
Starting with `ss-cloak-client v0.4`, a `System‑wide Proxy (SWP)` mode and `domain zone bypassing` were introduced (direct connections that обходят proxy, e.g. .ru, .ir, etc.).
